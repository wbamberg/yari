...
export function SidebarContainer({ doc, children }) {
  ...
  useEffect(() => {
    ...
    if (sidebar && currentSidebarItem) {
      ...
      // If the current sidebar item is already visible, don't scroll
      ...
      if (
        ...
        distance - section.offsetTop < sidebar.clientHeight
      ) {
        sidebar.scrollTo({
          top: section.offsetTop,
        });
        // Otherwise, just scroll the current item into view
      } else {
        sidebar.scrollTo({
